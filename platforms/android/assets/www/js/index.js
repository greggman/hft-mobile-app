...
var app = {
    ...
    onDeviceReady: function() {
        //setTimeout(app.showRetry, 10000);
        //window.location.href = "http://happyfuntimes.net";
        //window.location.href = "http://localhost:18679";
        //setInterval(app.rotate, 3000);
          ...
          if (httpd) {
            httpd.startServer({
              ...
              if (url.toLowerCase().indexOf("error") < 0) {
                ...
                //var iframe = document.getElementById("hft");
